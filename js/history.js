 ...
 * @param {GraphSession} graphData the current state of the graph.
 * @param {GraphObject} editData the object to add to the graph.
 */
function addEdit(graphData, editData) {
    switch(editData.giveType()) {
        ...
        case GRAPH_DATATYPE.EDGE:
            ...
            editData.start.connect(editData);
            editData.end.connect(editData);
            break;
        default:
            console.error("Add edit not defined for type " + editData.getType());
    }
}
...
function removeEdit(graphData, editData) {
    switch(editData.giveType()) {
        ...
        case GRAPH_DATATYPE.EDGE:
            ...
            break;
        default:
            console.error("Remove edit not defined for type " + editData.getType());
    }
}
